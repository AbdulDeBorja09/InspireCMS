...
<div class="content" id="Membership">
    ...
    <div class="form-container">
        ...
        <form action="{{route('admin.CreateService')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="membership-brief">Brief Description.:</label>
                <input class="form-control " type="text" id="membership-brief" name="brief" placeholder="Input Here" />
            </div>
            <div class="form-group">
                <label for="membership-description">Description:</label>
                <textarea class="form-control " type="text" id="membership-description" name="description"
                    placeholder="Input Here" rows="5"> </textarea>
            </div>
            {{-- <div class="form-group">
                <label for="membership-rate">membership Rate:</label>
                <input class="form-control" type="text" id="membership-rate" name="membership"
    ...
    document.getElementById('add-rate').addEventListener('click', function() {
        ...
        rateRow.innerHTML = `
            ...
            <div>
                ...
                <label for="rate">membership Rate:</label>
